...
export const ModernROICalculator = () => {
    ...
    <div className="min-h-screen py-8 sm:py-12 lg:py-16 px-4">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
            Calculate Your Lost Revenue
          </h1>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            30-40% of emergency calls go unanswered. See exactly how much this is costing your business.
          </p>
        </motion.div>
